export const OBJECT_PERMISSIONS = {
  ...
  OWNERS_ADD: 'owners_add', // добавление владельцев
  OWNERS_REMOVE: 'owners_remove', // удаление владецев
  REVIEW_CLAIM: 'review_claim', // жалоба на отзыв
  NOTIFICATION_SMS: 'notification_sms', // смс-уведомления
};
